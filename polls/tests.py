...
def create_choice(choice_text, question):
    """
    Create a choice with given choice_text and Question
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        create_choice("Choice", question1)
        question2 = create_question(question_text="Past question 2.", days=-5)
        create_choice("Choice", question2)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question2, question1],
    ...
    def test_question_without_choice(self):
        """
        Show only Questions that have Choices available
        """
        question1 = create_question(question_text="Past question 1.", days=-30)
        create_choice("My Choice", question1)
